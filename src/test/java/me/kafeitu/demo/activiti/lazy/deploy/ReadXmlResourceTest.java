...
public class ReadXmlResourceTest extends AbstractTest {
    ...
    public void testClasspathDeployment() throws Exception {
        ...
        String key = "candidateUserInUserTask";
        ProcessDefinition pd = repositoryService.createProcessDefinitionQuery().latestVersion().processDefinitionKey(key).singleResult();
        pd.getId();
