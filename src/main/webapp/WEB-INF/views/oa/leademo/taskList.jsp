...
<head>
	...
	<script src="${ctx }/js/module/oa/leademo/leave-todo.js" type="text/javascript"></script>
</head>
...
<body>
				...
				<tr id="${leave.id }" tid="${task.id }">
					...
					<td>
						<c:if test="${empty task.assignee }">
							<a class="claim" href="${ctx }/oa/leademo/task/claim/${task.id}">签收</a>
						</c:if>
	...
	<!-- 部门领导审批 -->
	<div id="dep_leader_audit" style="display: none">
	...
	<!-- HR审批 -->
	<div id="hr_audit" style="display: none">

		<!-- table用来显示信息，方便办理任务 -->
		<%@include file="view-form.jsp" %>
	</div>

	<div id="modify_apply" style="display: none">
	...
	<!-- 销假 -->
	<div id="report_back" style="display: none">
		<!-- table用来显示信息，方便办理任务 -->
		<%@include file="view-form.jsp" %>
		<hr/>
		<table>
