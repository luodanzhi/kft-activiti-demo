...
<head>
	...
	<script src="${ctx }/js/module/oa/vehedit/leave-todo.js" type="text/javascript"></script>
</head>
...
<body>
				...
				<tr id="${leave.id }" tid="${task.id }">
					...
					<a class="handle" tkey='${task.taskDefinitionKey }' tname='${task.name }' href="#">办理</a>
						<%--<c:if test="${empty task.assignee }">
							<a class="claim" href="${ctx }/oa/vehedit/task/claim/${task.id}">签收</a>
						</c:if>
	...
	<!-- 县审批 -->
	<div id="countryAppr" style="display: none">
	...
	<!-- 市审批 -->
	<div id="cityAppr" style="display: none">

		<!-- table用来显示信息，方便办理任务 -->
		<%@include file="view-form.jsp" %>
	</div>
	<!-- 省审批 -->
	<div id="provinceAppr" style="display: none">

		<!-- table用来显示信息，方便办理任务 -->
		<%@include file="view-form.jsp" %>
	</div>
	<!-- 申请 -->
	<div id="editApply" style="display: none">
