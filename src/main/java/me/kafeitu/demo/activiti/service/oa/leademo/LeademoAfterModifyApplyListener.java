...
@Component
@Transactional
public class LeademoAfterModifyApplyListener implements TaskListener {

    private static final long serialVersionUID = 1L;

    @Autowired
    LeademoManager leademoManager;
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        Leave leave = leademoManager.getLeave(new Long(processInstance.getBusinessKey()));
        ...
        leademoManager.saveLeave(leave);
    }
