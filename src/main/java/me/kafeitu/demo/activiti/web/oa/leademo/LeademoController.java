package me.kafeitu.demo.activiti.web.oa.leademo;
...
import me.kafeitu.demo.activiti.service.oa.leademo.LeademoManager;
import me.kafeitu.demo.activiti.service.oa.leademo.LeademoWorkflowService;
 ...
 */
@Controller
@RequestMapping(value = "/oa/leademo")
public class LeademoController {
    private Logger logger = LoggerFactory.getLogger(getClass());
    
    @Autowired
    protected LeademoManager leademoManager;
    
    @Autowired
    protected LeademoWorkflowService workflowService;
    ...
    public String startWorkflow(Leave leave, RedirectAttributes redirectAttributes, HttpSession session) {
        ...
        return "redirect:/oa/leademo/apply";
    }
    ...
    public ModelAndView taskList(HttpSession session, HttpServletRequest request) {
        ModelAndView mav = new ModelAndView("/oa/leademo/taskList");
    ...
    public ModelAndView runningList(HttpServletRequest request) {
        ModelAndView mav = new ModelAndView("/oa/leademo/running");
        Page<Leave> page = new Page<Leave>(PageUtil.PAGE_SIZE);
        int[] pageParams = PageUtil.init(page, request);
    ...
    public ModelAndView finishedList(HttpServletRequest request) {
        ModelAndView mav = new ModelAndView("/oa/leademo/finished");
        Page<Leave> page = new Page<Leave>(PageUtil.PAGE_SIZE);
        int[] pageParams = PageUtil.init(page, request);
    ...
    public String claim(@PathVariable("id") String taskId, HttpSession session, RedirectAttributes redirectAttributes) {
        ...
        return "redirect:/oa/leademo/list/task";
    }
    ...
    public Leave getLeave(@PathVariable("id") Long id) {
        Leave leave = leademoManager.getLeave(id);
        return leave;
    }
